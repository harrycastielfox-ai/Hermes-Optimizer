        ...
        <main className="flex-1 overflow-auto px-5 pt-6 pb-5 xl:px-8 xl:pt-7">
          <div className="mb-5 flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-4xl text-sm leading-relaxed text-muted-foreground">
                O Hermes mistura diagnostico, preparacao, sessao Gamer e ferramentas sem esconder
                risco. Esta tela monta o caminho certo e leva cada acao para o modulo seguro.
              </p>
            </div>
          ...
          <section className="mt-4 rounded-2xl border border-border/60 bg-card p-4 shadow-[0_1px_2px_rgba(15,23,42,0.04),0_10px_28px_-18px_rgba(15,23,42,0.18)]">
            <div className="mb-4 flex flex-col gap-1 sm:flex-row sm:items-end sm:justify-between">
              ...
              <span className="w-fit rounded-full border border-primary/20 bg-primary/10 px-3 py-1 text-[11px] font-bold text-primary">
                Diagnostico separado de alteracoes
              </span>
            </div>
          ...
          <section className="mt-4 grid grid-cols-1 gap-3 xl:grid-cols-3">
            <PrincipleCard
              icon={ShieldCheck}
              title="Sem surpresa"
              description="Analisar Agora continua somente leitura. Toda alteracao vai para Perfil ou Ferramenta."
            />
            <PrincipleCard
              icon={RotateCcw}
              title="Voltar atras"
              description="Perfis e ferramentas precisam de snapshot, historico ou rotulo claro de irreversivel."
            />
            <PrincipleCard
              icon={Gamepad2}
              title="Sessao Gamer"
  ...
  return [
    {
      ...
      description: "Coleta completa, score, hardware e recomendacoes sem alterar o Windows.",
      ...
      icon: ListChecks,
      bullets: [
        hasDiagnostic ? "Diagnostico real disponivel" : "Aguardando backend Tauri",
    ...
    },
    {
      ...
      description: "Agrupa reparo, componentes, limpeza e configuracoes pesadas em modulos claros.",
      status: "manual",
      risk: "alto",
      time: "2 a 10 min",
      cta: "Abrir Reparo",
      ...
      bullets: [
        ...
        "SFC/DISM nunca rodam no diagnostico rapido",
        "Pode exigir administrador e reinicio",
      ],
    },
    {
      id: "cleanup-startup",
      title: "Limpeza e Inicializacao",
      ...
      risk: "medio",
      time: "ate 3 cliques",
      cta: cleanupGb > 0 ? "Abrir Limpeza" : "Abrir Inicializacao",
