...
O Hermes Optimizer 0.1.0 nao possui ativacao real, pagamento integrado, validacao de chave, login LigaHub ou chamada para servidor de licenca.
...
O fluxo real aprovado para uma fase futura esta documentado em `docs/futuro-ligahub-auth.md`.

## Criterio para descongelar

Descongelar somente quando existir:

- MU-plugin WordPress real na LigaHub.
